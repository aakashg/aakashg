...
- AI prompts for PM work: user stories, competitive teardowns, launch risk, metrics, status updates
- Claude Code skills: idea validation, design review, LinkedIn writing, prompt engineering
- PM operating system: CLAUDE.md configs, skill libraries, sub-agent setups
- Open source templates: PRD structures, project READMEs, profile guides
- Guides on AI product management: pricing, discovery, prototyping, agents, MCP

### About Me

- **VP Product at Apollo.io** when the company became a unicorn ($750M to $2.5B valuation). Led growth, pricing & packaging, activation, expansion, and engagement teams
